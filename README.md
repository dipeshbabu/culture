...
When these values are present, the app calls Claude Opus through Portkey. If the gateway is unavailable or returns malformed JSON, the app falls back to the deterministic demo responses so the hackathon demo still works.
